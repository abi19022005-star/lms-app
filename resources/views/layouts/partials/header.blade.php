    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <button
                    @click="toggleSidebar()"
                    class="block p-2 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 md:hidden"
                >
                ...
                <a href="{{ url('/dashboard') }}" class="flex items-center gap-2 group">
                    <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-transparent to-transparent rounded-xl shadow-md transition-all duration-300 group-hover:shadow-lg group-hover:scale-105">

                        @if(setting('app_logo'))
                            <img
                                src="{{ asset('storage/' . setting('app_logo')) }}"
                                alt="Logo"
                                class="h-auto w-auto object-contain rounded-xl shadow-md border border-gray p-0.5  hover:scale-105 transition duration-300 ease-in-out"
                            >
                        @else
